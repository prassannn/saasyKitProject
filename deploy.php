...
$remoteUser = 'root';   // the user that will be used to connect to remote server and deploy the app
$sudoPassword = 'ewuBTKmvVchS1@hf%';  // the sudo password of the remote user

$deployPath = '~/app';      // the path where the app will be deployed on the remote server

$host = '57.129.128.69';    // the host of the remote server (can be an IP or domain)
$domain = 'test.expirationalert.com';   // the domain of the app

$repository = 'https://github.com/prassannn/saasyKitProject.git';      // has to be in the SSH format
...
desc('Provision Deployer (placeholder)');
task('provision:deployer', function () {
    writeln('Provision: Deployer placeholder task.');
});
